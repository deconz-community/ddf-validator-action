...
const ddf_validator_1 = __nccwpck_require__(189);
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const inputFiles = yield (0, glob_1.default)(inputDirectory, {
            ...
            for (const file of inputFiles) {
                ...
                try {
                    ...
                    if (error instanceof zod_1.ZodError)
                        core.error((0, zod_validation_error_1.fromZodError)(error).message);
...
const index_js_1 = __importDefault(__nccwpck_require__(2098));
...
const brace_expressions_js_1 = __nccwpck_require__(4195);
const escape_js_1 = __nccwpck_require__(8448);
const unescape_js_1 = __nccwpck_require__(7352);
...
exports.Minimatch = Minimatch;
/* c8 ignore start */
var escape_js_2 = __nccwpck_require__(8448);
Object.defineProperty(exports, "escape", ({ enumerable: true, get: function () { return escape_js_2.escape; } }));
var unescape_js_2 = __nccwpck_require__(7352);
...
const lru_cache_1 = __importDefault(__nccwpck_require__(6073));
